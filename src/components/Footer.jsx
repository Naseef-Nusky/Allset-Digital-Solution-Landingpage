    ...
    <footer className="border-t border-slate-100 bg-white px-4 py-10 pb-28 lg:pb-10">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-start lg:justify-between lg:gap-8">
          ...
          <div className="w-full text-center lg:w-auto lg:text-left">
            ...
            <div className="mt-3 space-y-2.5">
              <a
                ...
                className="flex items-center justify-center gap-3 text-slate-600 transition hover:text-emerald-600 lg:justify-start"
              >
                <ContactIcon>
          ...
          <div className="flex w-full flex-col items-center text-sm text-slate-400 lg:w-auto lg:items-end lg:text-right">
            <Link
              to="/privacy-policy"
